                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div id="collapseOne" class="accordion-body collapse in body">
                            <form action="{{ route('adgoldfish185.post.postAdd') }}" class="form-horizontal" id="block-validate" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="{!! csrf_token() !!}">
                                <div class="form-group">
                                    <label class="control-label col-lg-2">Tên bài viết</label>
                                    <div class="col-lg-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <select class="form-control" name="id_cate">
                                            ...
                                            <?php cate_parent ($lCate, old('id_cate')); ?>
                                        </select>
