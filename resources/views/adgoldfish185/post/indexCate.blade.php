            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <p><a href="{{ route('adgoldfish185.post.getAddCate') }}" class="btn btn-info">Thêm danh mục</a> </p>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                             ...
                                             ?>
                                            <div id="change{!! $Cate['id'] !!}" idCatePost="{!! $Cate['id'] !!}" class="make-switch has-switch changestatusCatePost" data-on="warning" data-off="danger">
                                        ...
                                        <td style="text-align: center;">
                                            <a href="{{ route('adgoldfish185.post.getEditCate', $Cate['id']) }}" class="btn btn-success">Sửa</a>
                                            <a href="{{ route('adgoldfish185.post.getDelCate', $Cate['id']) }}" onclick="return confirm('Bạn có chắc chắn muốn xóa!!!')"  class="btn btn-success">Xóa</a>
                                        </td>
                                    </tr>
                                    <?php
                                        $i=$i+1;
