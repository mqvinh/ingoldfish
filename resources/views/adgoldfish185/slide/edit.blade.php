                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div id="collapseOne" class="accordion-body collapse in body">
                            <form action="{{ route('adgoldfish185.slide.postEdit', $Slide['id']) }}" class="form-horizontal" id="block-validate" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <img width="200px" height="200px" src="{{ asset('/resources/upload/'.$Slide['picture']) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-8">
                                        <textarea rows="10" id="preview" name="preview" class="form-control">{!! $Slide['preview'] !!}</textarea>
