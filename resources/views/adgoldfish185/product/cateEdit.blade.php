...
<div style="float: left; width: 82%">
    ...
    <div class="inner" style="min-height: 700px;">
      ...
      <hr />
     <!--BLOCK SECTION -->
        <p><a href="{{ route('adgoldfish185.product.getIndexCate') }}" class="btn btn-info">Quay lại</a> </p>
         <div class="row">
                <div class="col-lg-12">
                    <div class="box">
                        <header>
                        ...
                        <div id="collapseOne" class="accordion-body collapse in body">
                            <form action="{{ route('adgoldfish185.product.postEditCate', $Cate['id']) }}" class="form-horizontal" id="block-validate" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="_token" value="{!! csrf_token() !!}">
                                <div class="form-group">
                                    <label class="control-label col-lg-4">Tên</label>
                                    <div class="col-lg-4">
                                        <input type="text" id="name" name="name" class="form-control" value="{!! $Cate['name'] !!}"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <textarea rows="10" id="preview" name="preview" class="form-control" value="{!! $Cate['preview'] !!}">
                                        </textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <img class="form-control" style="height: 200px" src="{{ asset('/resources/upload/'.$Cate['picture']) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" id="title" name="title" class="form-control" value="{!! $Cate['title'] !!}"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" id="keywords" name="keywords" class="form-control" value="{!! $Cate['keywords'] !!}"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <input type="text" id="description" name="description" class="form-control" value="{!! $Cate['description'] !!}"/>
