                ...
                <div class="col-lg-12">
                    <div class="box">
                        ...
                        <div id="collapseOne" class="accordion-body collapse in body">
                            <form action="{{ route('adgoldfish185.product.postAddCate') }}" class="form-horizontal" id="block-validate" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <textarea rows="10" id="preview" name="preview" class="form-control" value="{!! old('preview') !!}">
                                        </textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-4">
                                        <textarea rows="10" id="description" name="description" class="form-control" value="{!! old('description') !!}">
                                        </textarea>
